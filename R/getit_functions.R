...
#' Prevalence of types of cancer patients (2016) and the number of hospital beds per 1000 people (2017) were obtained from
#' \href{http://www.dati.salute.gov.it/}{Ministero della Salute}. Note that cancer patients prevalence was calculated using
#'  region population estimates of 2019. Data of particulate 2.5 (2017) comes from the
#' \href{https://annuario.isprambiente.it/pon/basic/14}{Istituto Superiore Per La protezione Ambientale}.
#' @source  \href{https://github.com/pcm-dpc/COVID-19}{protezione civile}, \href{http://dati.istat.it/?lang=en}{ISTAT}, \href{http://www.dati.salute.gov.it/}{Ministero della Salute}
#' @importFrom rlang .data
#' @importFrom magrittr %>%
...
#' \code{\link{it_chronic}}, \code{\link{it_dem}}, \code{\link{it_firstaid}},
...
getit_all <- function() {
  ...
  dat1 <- plyr::join_all(list(cmr_it, it_house, dem_65bin_fm, it_regions), by = "region", type = "inner") %>%
