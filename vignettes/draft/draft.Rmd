---
title: "covid19cenus: a package to xxx"
#date: "`r Sys.Date()`"
authors:
...
In the mist of a virus pandemic, the analysis (use a fancier term) of the constant flow of epidemiological data is of paramount importance not only to  guide the implementation and evaluation of non-parmacological interventions, but also to  optimize drug development. 
