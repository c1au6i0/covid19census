...
* `us_fl65`:  percentage of fee-for-service (FFS) Medicare enrollees that had an annual flu vaccination (2019)
* `us_hospbeds`: total hospital beds in each county (2019).
* `us_netinc`: median househould income (2018).
* `us_mmd`: data of 2019 regarding the  prevalence found in medicare beneficiaries of 
