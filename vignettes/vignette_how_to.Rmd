...
For *U.S* the prefix of the function is `getus_` follow by the specific metric of interest:
  ...
  * `getus_all`: executes all the above function and join the results with other datasets statically contained in the package
...
dim(dat_us)
```
For *Italy" the prefix of the function is `getit_` follow by the specific metric of interest:
  ...
  * `getit_all`: executes all the above function and join the results with other datasets statically contained in the package
