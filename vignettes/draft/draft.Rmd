...
Information  on the dataframes generated by the two functions are reported in table  below (\ref{tab:tab_dat}).
...
For example, in (\ref{fig:fig_corr}) correlation analysis of pair of selected U.S. variables and relative visualization. 
