...
For *U.S* the prefix of the function is `getus_`, followed by the specific metric of interest:
  ...
  * `getus_covid`: extracts data of COVID-19 from the [New York Time git repository](https://github.com/nytimes/covid-19-data) or the [Johns Hopkins University](https://github.com/CSSEGISandData).
