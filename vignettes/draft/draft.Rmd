...
For **U.S** the prefix of the functions to extract data is `getus_`, and it is followed by the specific metric of interest:
  ...
  * `getus_all`: executes all the above functions and join the results with other datasets statically contained in the package, and returns a `dataframe` with 313 variables.
