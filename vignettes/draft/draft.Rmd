...
The following code launchs the functions and assign the returned `dataframes` to different names.
...
rownames(tab1) <-
  c("variables", "counties-regions", "sources", "from")


print(
  xtable(
    tab1,
    caption = "Dataframes retuned by functions",
    label = "tab:tab1",
    align = c("c", "c", "c")
  ),
  comment = FALSE
...
```{r fig_corr, fig.cap="United States Correlation Matrix", results="asis", echo=FALSE, fig.height=4, fig.width=4, warning=FALSE, message=FALSE}
