...
In the current example, an additional confounder, percentage of people with cancer, was added to the model. Update data of deaths, cases and tests as well as other demographic indexes were retrieved with the function `getus_all`. A total of 19 variables were selected for analysis. Figure \ref{fig:fig_corr} displays a correlation analysis of pairs of selected variables.
...
The main analysis of Wu et al. [-@wu2020m], a zero-inflated negative binomial mixed models, was replicated using updated U.S data and by including an additional factor (percent of people with cancer) in the model.
