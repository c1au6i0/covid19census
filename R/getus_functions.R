...
#'  ANCESTRY, COMPUTER OR INTERNET, POPULATION AND SEX, POPULATION AND RACE, MEDICAL, POVERTY, ACTIVITY, POLLUTIONS AND TEMPERATURE, STATE LEVEL TESTS AND HOSPITALIZATIONS}. \cr
...
getus_all <- function(repo = "jhu") {
  ...
  to_join <- lapply(list(us_acm_househ, us_age_sex, us_race, us_hospbeds, us_mmd, us_poverty, us_netinc, us_pm2.5, us_season), function(x) {
