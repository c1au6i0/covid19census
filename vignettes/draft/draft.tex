...
For example, early analysis and modeling of COVID-19 confirmed cases and
deaths was employed to assess the effects of ongoing NPI in China and
Europe \citep{flaxman2020, prem2020tlph}. Moreover, aggregation of
COVID-19 epidemiological data with that regarding i) the seasonality of
other coronoviruses, ii) U.S. clinical care capacity, allowed to make
long-term predictions on possible effective containment strategies
\citep{kissler2020s}.
...
However, the implications and validity of that initial observation was
curtailed by subsequent models that took into account additional factors
\citep[e.s. age;][]{fukui2020m}. Overall, these few examples underscore
the importance, in general, of sharing data and, in particular, of
combining of datasets from different sources, for addressing the
...
regional level, respectivelty) from different sources and combine them
...
\begin{verbatim}
## US test data up to 2020-04-25 successfully retrived!
\end{verbatim}
...
For example, in {[}figure \ref{fig:fig_corr}{]} correlation analysis of
pair of selected U.S. variables and relative visualization.

\hypertarget{discussion}{%
\section{Discussion}\label{discussion}}

The \texttt{R} package \texttt{covid19census} does this and that so use
it
