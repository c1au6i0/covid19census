...
\title{covid19census: U.S. and Italy COVID-19 epidemiolagical data and,
...
\item
  ...
  results with other datasets statically contained in the package.
\end{itemize}
...
\item
  ...
  with other datasets statically contained in the package
\end{itemize}

\hypertarget{discussion}{%
\section{Discussion}\label{discussion}}

For U.S.,data regarding COVID-19 number of cases and deaths (at the
county level) were obtained from a repository mantained by the
\href{https://github.com/nytimes/covid-19-data}{New York Time}, whereas
number of tests and hospitalizations (at the state level) thefrom the
